...
TOKEN_INFECTION_CLUMP = 100 * SINGLETON_COLLECTION_AMOUNT # the number of tokns that a infection event infects, eg you have to have this many tokens to be able to be infected. For every TOKEN_INFECTION_CLUMP infected tokens you have you get MAX_INFECTIONS_PER_EPOCH infection transaction slots in the mempool
